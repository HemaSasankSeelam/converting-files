...
class Converting_files:
        ...
        try:
            ...
            if output_folder is None:  # for single file 
                ...
                if self.check_is_encrypted(input_path):
                    ...
                    if password is None:
                        termcolor.cprint(text="Enter The Password Please Try Again", color='red')
                        return
                ...
                for i in li:
                    if self.check_is_encrypted(i):
                        termcolor.cprint(text = f"File '{i}' Is Encrypted Decrypt The File To Convert Into 'docx' ",color='red')
                        return
                for i in li:
                ...
                termcolor.cprint(text=f"Files Is Saved On '{output_folder}' Folder",color='green')
        except AttributeError:
            termcolor.cprint(text=f"No Input File Is Selected",color='red')
        except pdf2docx.converter.ConversionException:
            termcolor.cprint(text=f"Entered Wrong Password Check Once '{password}' ",color='red')
    ...
    def jpeg_png(self):
        try:
            ...
            print(termcolor.colored(f"File Is Saved On '{output_path}' ",color="green"))
        except AttributeError:
            termcolor.cprint(text=f"No Input File Is Selected",color='red')
        except Exception as e:
            print(e)
    ...
    def pdf_encrypt(self):
        try:
            ...
            if self.check_is_encrypted(input_path):
                termcolor.cprint(text="Selected The Encrypted PDF File Only",color='red')
                return
            ...
            if password1 == "" or password1 == "Cancle" or password1 == None:
                termcolor.cprint("Password Must Require To Encrypt The File.",color='red')
                return
            ...
            if password2 == "" or password2 == "Cancle" or password2 == None:
                termcolor.cprint("Reverification Of Password Must Require To Encrypt The File",color='red')
                return
            if password1 != password2:
                print("\033[2J","\033[H",termcolor.colored(text=f"Entered Wrong Password For The Second Time '{password2}' ",color="red"))
                return
    ...
    def add_watermark(self):
        try:
            ...
            if self.check_is_encrypted(input_path):
                termcolor.cprint(text="Selected The Encrypted File To ADD Water Mark File Must Be Decrypted",color='red')
                return
            ...
            if self.check_is_encrypted(water_mark_location):
                termcolor.cprint(text="Selected The Encrypted File Decrypt The Water Mark File",color='red')
                return
            ...
            termcolor.cprint(text="No Input/Water Mark File Is Selected",color='red')
        except Exception as e:
            print(e)
    ...
    def pdf_decrypt(self):
        try:
            ...
            if not self.check_is_encrypted(input_path):
                termcolor.cprint(text="Selected The Normal PDF File Not Encrypted",color='red')
                return
            ...
            if password == "" or password == "Cancle" or password == None:
                termcolor.cprint("Password Must Require To Decrypt The File",color='red')
                return
            pdf_writer = PyPDF2.PdfWriter()
            with open(input_path,'rb') as fo:
                pdf_reader = PyPDF2.PdfReader(fo)
            ...
            if output_folder == "" or output_folder == None:
                termcolor.cprint("No Output Folder Is Selected",color="red")
                return
            ...
            termcolor.cprint(text=f"File Is Saved On The '{output_path}' ",color="green")
        
        except AttributeError:
            termcolor.cprint(text="No Input File Is Selected",color='red')
        except PyPDF2.errors.FileNotDecryptedError:
            termcolor.cprint(text=f"You Entered Wrong Password To Decrypt '{password}' ",color='red')
        except Exception as e:
            print(e)
    ...
    def pdf_split(self):
        try:
            ...
            with open(input_path,'rb') as fo:
                pdf_reader = PyPDF2.PdfReader(fo)
                if pdf_reader.is_encrypted:
                    termcolor.cprint(text='Selected The Encrypted PDF Decrypt The PDF',color='red')
                    return
                max_pages = len(pdf_reader.pages)
            if max_pages < 2:
                termcolor.cprint(text="For Spliting Min Pages Should Be 2",color='red')
                return
            ...
            if split_page_no == None:
                termcolor.cprint("Enter The Page No To Get PDF",color='red')
                return
                ...
                termcolor.cprint(text=f"Files Are Saved On '{output_folder}' Folder",color='green')
                ...
                if page_nos == None:
                    ...
                    try:
                        ...
                        assert all(1 <= page <= max_pages for page in page_list), f"Page numbers must be between 1 and {max_pages}"
                    ...
                    with open(input_path,'rb') as fo:
                        ...
                        pdf_writer.write(output_path)
                    termcolor.cprint(text=f"File Is Saved On '{output_path}' Folder",color='green')
    ...
    def pdf_split_half(self):
        try:
            ...
            with open(input_path,'rb') as fo:
                pdf_reader = PyPDF2.PdfReader(fo)
                if pdf_reader.is_encrypted:
                    termcolor.cprint(text='Selected The Encrypted PDF To Split Decrypt The PDF',color='red')
                    return
                max_pages = len(pdf_reader.pages)
            if max_pages < 2:
                termcolor.cprint(text="For Spliting Min Pages Should Be 2",color='red')
    ...
    def pdf_merger(self):
        try:
            ...
            if conforamtion == 'Cancel':
                termcolor.cprint(text="Please Sort The Pages Order Like Page No 01,02...",color='red')
                return
            pdf_list = input_path.glob("*.*pdf")
            pdf_list = [Path(i).as_posix() for i in pdf_list]
            for i in pdf_list:
                if self.check_is_encrypted(i):
                    termcolor.cprint(text=f"File '{i}' Is Encrypted Decrypt The File To Further",color='red')
                    return
            ...
            if file == "" or file == None:
                termcolor.cprint(text="Must Enter The Name To Save The File")
                return
            ...
            print(termcolor.colored(f"Seletced The Empty File name '{os.path.join(output_folder,i)}' ",color='red'))
        except Exception as e:
            print(e)
    ...
    def pdf_compress(self):
        try:
            ...
            if self.check_is_encrypted(input_path):
                termcolor.cprint(text='Selected The Encrypted PDF To Compress Decrypt The PDF',color='red')
                return
            ...
            termcolor.cprint(text="No Internet Connection........",color='red')
        except Exception as e:
            print(e)
    ...
    def addpageno_PDF(self):
        try:
            ...
            if self.check_is_encrypted(input_path):
                termcolor.cprint(text="Selected The Encrypted PDF To Add PageNo's Decrypt The PDF",color='red')
                return
    ...
    def get_text(self):
        try:
            ...
            if self.check_is_encrypted(input_path):
                termcolor.cprint(text="Selected The Encrypted PDf TO Get TEXT Decrypt The PDF.",color='red')
                return
            ...
            termcolor.cprint(text=f"Files Are Saves At {output_folder}",color='green')
        except UnicodeError:
            for i in converted_list:
                os.remove(i) # removes the converted txt files
            termcolor.cprint(text="Unable To Extract Text From Some Pages",color='red')
        except FileExistsError:
            path = Path(output_folder)/(Path(input_path).stem + f" page no {i}.txt")
            termcolor.cprint(text=f"Filse Already Exist's In Folder '{path}' ",color='red')
        except AttributeError:
            termcolor.cprint(text="No Input File Is Selected",color='red')
        except Exception as e:
            print(e)
    ...
    def merger_txt(self,input_path=None,li=None):
        try:
            ...
            if input_path == None: #Means For Single files 
                ...
                if output_folder == "" or output_folder == None:
                    termcolor.cprint(text="No Output Fodler Is Selected",color='red')
            ...
            termcolor.cprint(text=f"Filse Already Exist's In Folder '{output_path}' ",color='red')
        except Exception as e:
            print(e)
            termcolor.cprint(text=f"Get An Exception We Removed File >'{output_path}' From System",color='red')
    ...
    def rotate_pdf(self):
        try:
            ...
            with open(input_path,'rb') as fo:
                pdf_reader = PyPDF2.PdfReader(fo)
                if pdf_reader.is_encrypted:
                    termcolor.cprint(text="Selected The Encrypted PDF To Get Rotated Pages Decrypt The PDF",color='red')
                    return
                max_pages = len(pdf_reader.pages)
            ...
            if rotation_angle%90 != 0 :
                termcolor.cprint(f"Enter The Angle Divisible By 90 '{rotation_angle}'.",color='red')
                return
                ...
                with open(input_path,'rb') as fo:
                    ...
                    for i in range(len(pages)):
                        ...
                        if i == page_no-1:
                            ...
                            pdf_writer.add_page(page)
                pdf_writer.write(output_path)
            termcolor.cprint(text=f"File Saved On '{output_path}' ",color='green')
        except AttributeError:
            termcolor.cprint(text="No Input File Is Selected",color='red')
        except Exception as e:
            print(e)
        ...
        match x:
            case 1:
                ...
                if input_path is None or input_path == "":
                    termcolor.cprint(text="No Input Folder Is Selected",color='red')
                    return
